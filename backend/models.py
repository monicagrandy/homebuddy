...
class ContractorSearchUsage(Base):
    __tablename__ = "contractor_search_usage"
    __table_args__ = (
        UniqueConstraint("user_id", "period_start", name="uq_contractor_search_usage_user_period"),
    )
